import { timestamp, bound, get, overlap } from './utilities'
import {
    MAP,
    TILE,
    METER,
...
var t2p      = function(t)     { return t*TILE                  },
    ...
    /**
     * Perform an action when a given key is pressed.
     * @param {object} ev The event object.
     * @param {number} key The key code.
     * @param {number} down True if the key is down, false if it is up.
     */
